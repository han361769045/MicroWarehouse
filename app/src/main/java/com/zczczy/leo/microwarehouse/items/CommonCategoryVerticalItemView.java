 ...
 */
@EViewGroup(R.layout.category_goods_item_vertical)
public class CommonCategoryVerticalItemView extends ItemView<GoodsModel> {
    ...
    public CommonCategoryVerticalItemView(Context context) {
        super(context);
    }
