...
import com.zczczy.leo.microwarehouse.adapters.lotteryadapters.LotteryUltimateRecyclerViewAdapter;
...
public abstract  class LotteryUltimateRecyclerViewActivity<T> extends BaseLotteryActivity {

    @ViewById
    CustomUltimateRecyclerview ultimateRecyclerView;

    LotteryUltimateRecyclerViewAdapter<T> myAdapter;
